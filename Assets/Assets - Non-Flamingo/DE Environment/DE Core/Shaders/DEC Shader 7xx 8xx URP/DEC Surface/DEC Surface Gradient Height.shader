...
Shader "DEC/Surface/Surface Gradient Height"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord2_g39586 = IN.ase_texcoord8.xy * appendResult150_g38531 + appendResult151_g38531;
				...
				float4 ALBEDO151_g39556 = OUT_ALBEDO_RGBA1177_g38531;
				...
				float4 temp_output_7_0_g38531 = ( localfloat4switch143_g39556 * float4( (OUT_ALBEDO_RGBA1177_g38531).rgb , 0.0 ) * _Brightness );
				float4 temp_output_39_0_g39591 = ( temp_output_7_0_g38531 + float4(0,0,0,0) );
				...
				float2 texCoord67_g39591 = IN.ase_texcoord8.xy * appendResult132_g39591 + appendResult114_g39591;
				...
				float2 texCoord220_g39591 = IN.ase_texcoord8.xy * appendResult219_g39591 + appendResult206_g39591;
				...
				float3 NORMAL_OUT314_g38531 = temp_output_1478_59_g38531;
				...
				float3 temp_output_38_0_g39591 = ( temp_output_1478_59_g38531 + ADDITIONAL_LIGHT1342_g38531 );
				...
				float4 temp_cast_19 = (_SmoothnessStrength).xxxx;
				float4 m_Smoothness170_g39551 = temp_cast_19;
				float4 temp_cast_20 = (( 1.0 - _SmoothnessStrength )).xxxx;
				float4 m_Roughness170_g39551 = temp_cast_20;
				...
				float3 NORMAL_WORLD_OUT164_g38531 = temp_output_1478_59_g38531;
				...
				float4 temp_cast_21 = (ALBEDO_R169_g38531).xxxx;
				float4 FINAL_GEOMETRIC114_g39551 = ( temp_output_28_0_g39551 * ( 1.0 - temp_cast_21 ) );
				...
				float4 temp_cast_23 = (IN.ase_color.a).xxxx;
				float4 lerpResult11_g38531 = lerp( _MASK_R1439_g38531 , temp_cast_23 , (float)_OcclusionSourceMode);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult150_g38531 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38531 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39586 = IN.ase_texcoord4.xy * appendResult150_g38531 + appendResult151_g38531;
				float2 appendResult6_g39586 = (float2(texCoord2_g39586.x , texCoord2_g39586.y));
				float2 OUT_UV431_g38531 = appendResult6_g39586;
				float2 UV40_g39580 = OUT_UV431_g38531;
				float4 tex2DNode63_g39580 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g39580 );
				...
				float2 appendResult132_g39591 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g39591 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g39591 = IN.ase_texcoord4.xy * appendResult132_g39591 + appendResult114_g39591;
				float4 tex2DNode45_g39591 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat, texCoord67_g39591 );
				float4 ALBEDO_OUT255_g39591 = ( _ColorDetail * tex2DNode45_g39591 * _Brightness );
				float4 m_Off226_g39591 = ALBEDO_OUT255_g39591;
				float2 appendResult219_g39591 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g39591 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g39591 = IN.ase_texcoord4.xy * appendResult219_g39591 + appendResult206_g39591;
				float temp_output_15_0_g39595 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat, texCoord220_g39591 ).r );
				float temp_output_26_0_g39595 = _Detail_BlendAmountMask;
				float temp_output_24_0_g39595 = _Detail_BlendHardnessMask;
				float saferPower2_g39595 = max( max( saturate( (0.0 + (temp_output_15_0_g39595 - ( 1.0 - temp_output_26_0_g39595 )) * (temp_output_24_0_g39595 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g39595 ))) ) , 0.0 ) , 0.0001 );
...
/*ASEBEGIN
Version=18913
4;29.33333;1436;766;-129.5756;1238.221;1.74106;True;False
Node;AmplifyShaderEditor.CommentaryNode;386;1378.703,-386.772;Inherit;False;315.3578;113.8246;DESF Common ASE Compile Shaders;1;387;;0,0.2047877,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;290;1370.761,-877.7997;Inherit;False;358.9639;190.9279;DEBUG SETTINGS ;3;293;353;291;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;295;1376.092,-1016.18;Inherit;False;168.7208;124.4731;GLOBAL SETTINGS ;1;379;;0.09433961,0.09433961,0.09433961,1;0;0
Node;AmplifyShaderEditor.FunctionNode;388;704.2912,-682.9274;Inherit;False;DESF Core Surface;3;;38531;c3df20d62907cd04086a1eacc41e29d1;19,1352,2,183,2,1382,0,1432,1,1433,1,1434,1,1491,0,1284,2,1446,0,307,0,312,0,1318,0,249,0,1319,0,1336,0,1337,0,1407,0,1443,0,1444,0;2;309;FLOAT3;0,0,0;False;1262;FLOAT4;0,0,0,0;False;10;FLOAT4;42;FLOAT3;39;FLOAT3;1473;COLOR;0;FLOAT4;41;COLOR;43;FLOAT;180;FLOAT;55;FLOAT;281;FLOAT3;313
Node;AmplifyShaderEditor.IntNode;291;1379.99,-836.0845;Inherit;False;Property;_ColorMask;Color Mask Mode;1;1;[Enum];Create;False;1;;0;1;None,0,Alpha,1,Red,8,Green,4,Blue,2,RGB,14,RGBA,15;True;0;False;15;15;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;353;1381.739,-760.9539;Inherit;False;Constant;_MaskClipValue1;Mask Clip Value;14;0;Create;True;1;;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;379;1397.978,-978.0327;Inherit;False;Property;_CullMode;Cull Mode;2;2;[Header];[Enum];Create;False;1;GLOBAL SETTINGS;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;385;1104.497,-679.5143;Inherit;False;DESF Module Detail;66;;39591;49c077198be2bdb409ab6ad879c0ca28;4,200,1,201,1,347,0,346,0;2;39;FLOAT4;0,0,0,0;False;38;FLOAT3;0,0,1;False;2;FLOAT4;73;FLOAT3;72
Node;AmplifyShaderEditor.FunctionNode;387;1389.555,-348.8178;Inherit;False;DESF Common ASE Compile Shaders;-1;;39598;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;293;1570.169,-834.4561;Inherit;False;Property;_ZWriteMode;ZWrite Mode;0;2;[Header];[Enum];Create;False;1;DEBUG SETTINGS;0;1;Off,0,On,1;True;0;False;1;1;False;0;1;INT;0
...
ASEEND*/
//CHKSM=2C15C19E511DD2A916D5EAA3B4BC793C14CDE7B7