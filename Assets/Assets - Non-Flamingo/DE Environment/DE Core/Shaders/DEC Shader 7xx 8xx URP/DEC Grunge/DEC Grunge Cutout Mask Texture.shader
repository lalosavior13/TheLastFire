...
Shader "DEC/Grunge/Grunge Cutout Mask Texture"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float floatswitch1287_g37961( int m_switch, float m_Off, float m_Active )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float2 appendResult168_g37961 = (float2(_TilingX , _TilingY));
				float2 appendResult167_g37961 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39802 = IN.ase_texcoord8.xy * appendResult168_g37961 + appendResult167_g37961;
				float2 appendResult6_g39802 = (float2(texCoord2_g39802.x , texCoord2_g39802.y));
				float2 OUT_UV213_g37961 = appendResult6_g39802;
				float2 UV40_g39808 = OUT_UV213_g37961;
				float4 tex2DNode63_g39808 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g39808 );
				float4 ALBEDO_RGBA1381_g37961 = tex2DNode63_g39808;
				float4 ALBEDO151_g39811 = ALBEDO_RGBA1381_g37961;
				...
				float4 temp_output_3_0_g37961 = ( localfloat4switch143_g39811 * float4( (ALBEDO_RGBA1381_g37961).rgb , 0.0 ) * _Brightness );
				float4 temp_output_6_0_g39827 = ( temp_output_3_0_g37961 + float4(0,0,0,0) );
				...
				float2 texCoord794_g39827 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39850 = cos( radians( _Horizontalwear_Rotation ) );
				float sin1_g39850 = sin( radians( _Horizontalwear_Rotation ) );
				float2 rotator1_g39850 = mul( texCoord794_g39827 - float2( 0.5,0.5 ) , float2x2( cos1_g39850 , -sin1_g39850 , sin1_g39850 , cos1_g39850 )) + float2( 0.5,0.5 );
				...
				float4 smoothstepResult75_g39857 = smoothstep( temp_cast_15 , temp_cast_16 , (float4( 0,0,0,0 ) + (( 1.0 - MASK_HORIZONTAL204_g39857 ) - temp_cast_20) * (temp_cast_21 - float4( 0,0,0,0 )) / (float4( 1,1,1,1 ) - temp_cast_20)));
				...
				float2 texCoord1584_g39827 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39844 = cos( radians( _Verticalwear_Rotation ) );
				float sin1_g39844 = sin( radians( _Verticalwear_Rotation ) );
				float2 rotator1_g39844 = mul( texCoord1584_g39827 - float2( 0.5,0.5 ) , float2x2( cos1_g39844 , -sin1_g39844 , sin1_g39844 , cos1_g39844 )) + float2( 0.5,0.5 );
				...
				float4 smoothstepResult75_g39828 = smoothstep( temp_cast_26 , temp_cast_27 , (float4( 0,0,0,0 ) + (( 1.0 - MASK_SIDE163_g39828 ) - temp_cast_31) * (temp_cast_32 - float4( 0,0,0,0 )) / (float4( 1,1,1,1 ) - temp_cast_31)));
				...
				float2 texCoord28_g39827 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39859 = cos( radians( _Curvaturewear_Rotation ) );
				float sin1_g39859 = sin( radians( _Curvaturewear_Rotation ) );
				float2 rotator1_g39859 = mul( texCoord28_g39827 - float2( 0.5,0.5 ) , float2x2( cos1_g39859 , -sin1_g39859 , sin1_g39859 , cos1_g39859 )) + float2( 0.5,0.5 );
				...
				float3 break24_g39836 = ( temp_output_40_0_g39836 - temp_cast_42 );
				...
				float4 smoothstepResult75_g39836 = smoothstep( temp_cast_37 , temp_cast_38 , (float4( 0,0,0,0 ) + (( 1.0 - ( MASK_VERTICAL_X159_g39836 + MASK_VERTICAL_Y157_g39836 + MASK_VERTICAL_Z155_g39836 ) ) - temp_cast_43) * (temp_cast_44 - float4( 0,0,0,0 )) / (float4( 1,1,1,1 ) - temp_cast_43)));
				...
				float4 NORMAL_RGB1382_g37961 = SAMPLE_TEXTURE2D( _BumpMap, sampler_trilinear_repeat, UV40_g39808 );
				float4 temp_output_1_0_g39806 = NORMAL_RGB1382_g37961;
				...
				float3 temp_output_1519_59_g37961 = unpack52_g39806;
				float3 NORMAL_IN42_g39824 = temp_output_1519_59_g37961;
				...
				float3 temp_output_1610_30_g37961 = localfloat3switch37_g39824;
				float3 NORMAL_OUT1491_g37961 = temp_output_1610_30_g37961;
				float3 temp_output_16_0_g39796 = NORMAL_OUT1491_g37961;
				...
				float3 ADDITIONAL_LIGHT1212_g37961 = localAdditionalLightsFlat60_g39796;
				float3 temp_output_8_0_g39827 = ( switchResult58_g39824 + ADDITIONAL_LIGHT1212_g37961 );
				...
				float4 MASK_B1377_g37961 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_trilinear_repeat, UV40_g39808 );
				float4 temp_output_977_0_g39827 = ( _MetallicStrength * MASK_B1377_g37961 );
				...
				float3 tanNormal1608_g37961 = NORMAL_OUT1491_g37961;
				float3 worldNormal1608_g37961 = normalize( float3(dot(tanToWorld0,tanNormal1608_g37961), dot(tanToWorld1,tanNormal1608_g37961), dot(tanToWorld2,tanNormal1608_g37961)) );
				float3 temp_output_4_0_g39758 = worldNormal1608_g37961;
				...
				float ALBEDO_R172_g37961 = tex2DNode63_g39808.r;
				float4 temp_cast_59 = (ALBEDO_R172_g37961).xxxx;
				...
				float ALBEDO_A926_g37961 = tex2DNode63_g39808.a;
				int m_switch1287_g37961 = _GlancingClipMode;
				float m_Off1287_g37961 = 1.0;
				float3 normalizeResult1294_g37961 = normalize( cross( ddx( WorldPosition ) , ddy( WorldPosition ) ) );
				float dotResult1301_g37961 = dot( WorldViewDirection , normalizeResult1294_g37961 );
				float temp_output_1321_0_g37961 = ( 1.0 - abs( dotResult1301_g37961 ) );
				float m_Active1287_g37961 = ( 1.0 - ( temp_output_1321_0_g37961 * temp_output_1321_0_g37961 ) );
				float localfloatswitch1287_g37961 = floatswitch1287_g37961( m_switch1287_g37961 , m_Off1287_g37961 , m_Active1287_g37961 );
				float OPACITY_OUTMASK1277_g37961 = localfloatswitch1287_g37961;
				float CLIP_OPACITY200_g37961 = ( ALBEDO_A926_g37961 * OPACITY_OUTMASK1277_g37961 );
				float4 temp_cast_60 = (CLIP_OPACITY200_g37961).xxxx;
				...
				float4 MASK_G158_g37961 = SAMPLE_TEXTURE2D( _SmoothnessMap, sampler_trilinear_repeat, UV40_g39808 );
				float4 temp_output_83_0_g39758 = MASK_G158_g37961;
				...
				float4 temp_output_1324_33_g37961 = localfloat4switch188_g39758;
				float4 color1225_g37961 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 MASK_R1378_g37961 = SAMPLE_TEXTURE2D( _OcclusionMap, sampler_trilinear_repeat, UV40_g39808 );
				float4 temp_cast_62 = (IN.ase_color.a).xxxx;
				float4 lerpResult28_g37961 = lerp( MASK_R1378_g37961 , temp_cast_62 , (float)_OcclusionSourceMode);
				float4 lerpResult7_g37961 = lerp( color1225_g37961 , lerpResult28_g37961 , _OcclusionStrengthAO);
				float4 temp_output_989_0_g39827 = ( temp_output_1324_33_g37961 * lerpResult7_g37961 );
				...
				float AlphaCutoffBias1289_g37961 = _AlphaCutoffBias;
				...
				float Occlusion = saturate( lerpResult7_g37961 ).r;
				float Alpha = ( ALBEDO_A926_g37961 * OPACITY_OUTMASK1277_g37961 );
				float AlphaClipThreshold = AlphaCutoffBias1289_g37961;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 appendResult168_g37961 = (float2(_TilingX , _TilingY));
				float2 appendResult167_g37961 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39802 = IN.ase_texcoord2.xy * appendResult168_g37961 + appendResult167_g37961;
				float2 appendResult6_g39802 = (float2(texCoord2_g39802.x , texCoord2_g39802.y));
				float2 OUT_UV213_g37961 = appendResult6_g39802;
				float2 UV40_g39808 = OUT_UV213_g37961;
				float4 tex2DNode63_g39808 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g39808 );
				...
				float3 normalizeResult1294_g37961 = normalize( cross( ddx( WorldPosition ) , ddy( WorldPosition ) ) );
				float dotResult1301_g37961 = dot( ase_worldViewDir , normalizeResult1294_g37961 );
				float temp_output_1321_0_g37961 = ( 1.0 - abs( dotResult1301_g37961 ) );
				float m_Active1287_g37961 = ( 1.0 - ( temp_output_1321_0_g37961 * temp_output_1321_0_g37961 ) );
				float localfloatswitch1287_g37961 = floatswitch1287_g37961( m_switch1287_g37961 , m_Off1287_g37961 , m_Active1287_g37961 );
				float OPACITY_OUTMASK1277_g37961 = localfloatswitch1287_g37961;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult168_g37961 = (float2(_TilingX , _TilingY));
				float2 appendResult167_g37961 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39802 = IN.ase_texcoord4.xy * appendResult168_g37961 + appendResult167_g37961;
				float2 appendResult6_g39802 = (float2(texCoord2_g39802.x , texCoord2_g39802.y));
				float2 OUT_UV213_g37961 = appendResult6_g39802;
				float2 UV40_g39808 = OUT_UV213_g37961;
				float4 tex2DNode63_g39808 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g39808 );
				...
				int _Horizontalwear_Mode1003_g39827 = _Horizontalwear_Mode;
				int m_switch1476_g39827 = _Horizontalwear_Mode1003_g39827;
				float2 texCoord794_g39827 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39850 = cos( radians( _Horizontalwear_Rotation ) );
				float sin1_g39850 = sin( radians( _Horizontalwear_Rotation ) );
				float2 rotator1_g39850 = mul( texCoord794_g39827 - float2( 0.5,0.5 ) , float2x2( cos1_g39850 , -sin1_g39850 , sin1_g39850 , cos1_g39850 )) + float2( 0.5,0.5 );
				float2 appendResult811_g39827 = (float2(_Horizontalwear_TilingXMask , _Horizontalwear_TilingYMask));
				...
				int _Verticalwear_Mode1004_g39827 = _Verticalwear_Mode;
				int m_switch1400_g39827 = _Verticalwear_Mode1004_g39827;
				float2 texCoord1584_g39827 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39844 = cos( radians( _Verticalwear_Rotation ) );
				float sin1_g39844 = sin( radians( _Verticalwear_Rotation ) );
				float2 rotator1_g39844 = mul( texCoord1584_g39827 - float2( 0.5,0.5 ) , float2x2( cos1_g39844 , -sin1_g39844 , sin1_g39844 , cos1_g39844 )) + float2( 0.5,0.5 );
				float2 appendResult41_g39827 = (float2(_Verticalwear_TilingXMask , _Verticalwear_TilingYMask));
				...
				int _Curvaturewear_Mode398_g39827 = _Curvaturewear_Mode;
				int m_switch1491_g39827 = _Curvaturewear_Mode398_g39827;
				float2 texCoord28_g39827 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39859 = cos( radians( _Curvaturewear_Rotation ) );
				float sin1_g39859 = sin( radians( _Curvaturewear_Rotation ) );
				float2 rotator1_g39859 = mul( texCoord28_g39827 - float2( 0.5,0.5 ) , float2x2( cos1_g39859 , -sin1_g39859 , sin1_g39859 , cos1_g39859 )) + float2( 0.5,0.5 );
				float2 appendResult38_g39827 = (float2(_Curvaturewear_TilingXMask , _Curvaturewear_TilingYMask));
...
/*ASEBEGIN
Version=18913
4;29.33333;1436;766;6267.833;4393.645;2.234717;True;False
Node;AmplifyShaderEditor.CommentaryNode;2820;-3951.45,-3847.181;Inherit;False;383.5028;196.4201;;4;2849;2760;202;2758;DEBUG SETTINGS ;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;2871;-3950.061,-3329.948;Inherit;False;312.6667;114;DESF Common ASE Compile Shaders;1;2872;;0,0.2047877,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;2819;-3950.129,-4005.892;Inherit;False;178.5;126.8;;1;2848;GLOBAL SETTINGS ;0.2101688,1,0,1;0;0
Node;AmplifyShaderEditor.FunctionNode;2874;-4724.247,-3643.134;Inherit;False;DESF Core Cutout;4;;37961;e0cdd7758f4404849b063afff4596424;26,1217,2,1311,2,1296,2,1156,2,1141,2,442,2,1509,0,1556,1,1557,1,1552,1,1309,1,1308,1,1333,0,1348,0,1596,0,1368,2,1569,0,96,0,1229,0,1236,0,830,0,1415,0,1399,0,1564,0,1566,0,1565,0;2;1234;FLOAT3;0,0,0;False;1274;FLOAT4;0,0,0,0;False;14;FLOAT4;38;FLOAT3;35;FLOAT3;1586;COLOR;37;FLOAT4;33;COLOR;34;FLOAT;441;FLOAT;46;FLOAT;814;FLOAT;552;FLOAT4;656;FLOAT4;657;FLOAT4;655;FLOAT3;1235
Node;AmplifyShaderEditor.IntNode;2760;-3766.712,-3812.285;Inherit;False;Property;_ZWriteMode;ZWrite Mode;0;2;[Header];[Enum];Create;False;1;DEBUG SETTINGS;0;1;Off,0,On,1;True;0;False;1;1;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;2873;-4311.556,-3639.438;Inherit;False;DESF Module Grunge;119;;39827;b0925d725c9bfd049b8ad9f4b41a5bd0;3,1487,0,1466,0,1473,0;4;6;FLOAT4;0,0,0,0;False;8;FLOAT3;0,0,0;False;977;FLOAT4;0,0,0,0;False;989;FLOAT4;0,0,0,0;False;4;FLOAT4;0;FLOAT3;9;FLOAT;991;FLOAT;990
Node;AmplifyShaderEditor.RangedFloatNode;2849;-3763.048,-3737.398;Inherit;False;Property;_AlphatoCoverage;Alpha to Coverage;2;1;[Enum];Create;False;1;;1;Option1;0;1;Off,0,On,1;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2872;-3943.061,-3288.948;Inherit;False;DESF Common ASE Compile Shaders;-1;;39826;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;2848;-3926.649,-3966.208;Inherit;False;Property;_CullMode;Cull Mode;3;2;[Header];[Enum];Create;True;1;GLOBAL SETTINGS;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;2;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;202;-3943.471,-3813.078;Inherit;False;Constant;_MaskClipValue;Mask Clip Value;64;1;[HideInInspector];Create;True;1;;0;0;True;0;False;0.5;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;2758;-3948.076,-3736.627;Inherit;False;Property;_ColorMask;Color Mask Mode;1;1;[Enum];Create;False;1;;0;1;None,0,Alpha,1,Red,8,Green,4,Blue,2,RGB,14,RGBA,15;True;0;False;15;15;False;0;1;INT;0
...
ASEEND*/
//CHKSM=2BE00A5EB579973121542943D190C5BD251276D4