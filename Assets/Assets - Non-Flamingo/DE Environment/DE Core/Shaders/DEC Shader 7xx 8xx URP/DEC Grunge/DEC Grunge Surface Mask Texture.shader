	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult150_g38044 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38044 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39586 = IN.ase_texcoord8.xy * appendResult150_g38044 + appendResult151_g38044;
				float2 appendResult6_g39586 = (float2(texCoord2_g39586.x , texCoord2_g39586.y));
				float2 OUT_UV431_g38044 = appendResult6_g39586;
				float2 UV40_g39580 = OUT_UV431_g38044;
				float4 tex2DNode63_g39580 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g39580 );
				float4 OUT_ALBEDO_RGBA1177_g38044 = tex2DNode63_g39580;
				float4 ALBEDO151_g39556 = OUT_ALBEDO_RGBA1177_g38044;
				...
				float4 temp_output_7_0_g38044 = ( localfloat4switch143_g39556 * float4( (OUT_ALBEDO_RGBA1177_g38044).rgb , 0.0 ) * _Brightness );
				float4 temp_output_6_0_g39591 = ( temp_output_7_0_g38044 + float4(0,0,0,0) );
				...
				float2 texCoord794_g39591 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39614 = cos( radians( _Horizontalwear_Rotation ) );
				float sin1_g39614 = sin( radians( _Horizontalwear_Rotation ) );
				float2 rotator1_g39614 = mul( texCoord794_g39591 - float2( 0.5,0.5 ) , float2x2( cos1_g39614 , -sin1_g39614 , sin1_g39614 , cos1_g39614 )) + float2( 0.5,0.5 );
				float2 appendResult811_g39591 = (float2(_Horizontalwear_TilingXMask , _Horizontalwear_TilingYMask));
				float2 appendResult1164_g39591 = (float2(_Horizontalwear_OffsetXMask , _Horizontalwear_OffsetYMask));
				float4 m_Off1476_g39591 = SAMPLE_TEXTURE2D( _Horizontalwear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39614*appendResult811_g39591 + appendResult1164_g39591) );
				float4 m_Active1476_g39591 = SAMPLE_TEXTURE2D( _Horizontalwear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39614*appendResult811_g39591 + appendResult1164_g39591) );
				float4 m_ActiveInverted1476_g39591 = saturate( ( 1.0 - SAMPLE_TEXTURE2D( _Horizontalwear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39614*appendResult811_g39591 + appendResult1164_g39591) ) ) );
				...
				float4 smoothstepResult75_g39621 = smoothstep( temp_cast_15 , temp_cast_16 , (float4( 0,0,0,0 ) + (( 1.0 - MASK_HORIZONTAL204_g39621 ) - temp_cast_20) * (temp_cast_21 - float4( 0,0,0,0 )) / (float4( 1,1,1,1 ) - temp_cast_20)));
				...
				float2 texCoord1584_g39591 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39608 = cos( radians( _Verticalwear_Rotation ) );
				float sin1_g39608 = sin( radians( _Verticalwear_Rotation ) );
				float2 rotator1_g39608 = mul( texCoord1584_g39591 - float2( 0.5,0.5 ) , float2x2( cos1_g39608 , -sin1_g39608 , sin1_g39608 , cos1_g39608 )) + float2( 0.5,0.5 );
				float2 appendResult41_g39591 = (float2(_Verticalwear_TilingXMask , _Verticalwear_TilingYMask));
				float2 appendResult1165_g39591 = (float2(_Verticalwear_OffsetXMask , _Verticalwear_OffsetYMask));
				float4 m_Off1400_g39591 = SAMPLE_TEXTURE2D( _Verticalwear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39608*appendResult41_g39591 + appendResult1165_g39591) );
				float4 m_Active1400_g39591 = SAMPLE_TEXTURE2D( _Verticalwear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39608*appendResult41_g39591 + appendResult1165_g39591) );
				float4 m_ActiveInverted1400_g39591 = saturate( ( 1.0 - SAMPLE_TEXTURE2D( _Verticalwear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39608*appendResult41_g39591 + appendResult1165_g39591) ) ) );
				...
				float4 smoothstepResult75_g39592 = smoothstep( temp_cast_26 , temp_cast_27 , (float4( 0,0,0,0 ) + (( 1.0 - MASK_SIDE163_g39592 ) - temp_cast_31) * (temp_cast_32 - float4( 0,0,0,0 )) / (float4( 1,1,1,1 ) - temp_cast_31)));
				...
				float2 texCoord28_g39591 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39623 = cos( radians( _Curvaturewear_Rotation ) );
				float sin1_g39623 = sin( radians( _Curvaturewear_Rotation ) );
				float2 rotator1_g39623 = mul( texCoord28_g39591 - float2( 0.5,0.5 ) , float2x2( cos1_g39623 , -sin1_g39623 , sin1_g39623 , cos1_g39623 )) + float2( 0.5,0.5 );
				float2 appendResult38_g39591 = (float2(_Curvaturewear_TilingXMask , _Curvaturewear_TilingYMask));
				float2 appendResult1168_g39591 = (float2(_Curvaturewear_OffsetXMask , _Curvaturewear_OffsetYMask));
				float4 m_Off1491_g39591 = SAMPLE_TEXTURE2D( _Curvaturewear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39623*appendResult38_g39591 + appendResult1168_g39591) );
				float4 m_Active1491_g39591 = SAMPLE_TEXTURE2D( _Curvaturewear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39623*appendResult38_g39591 + appendResult1168_g39591) );
				float4 m_ActiveInverted1491_g39591 = saturate( ( 1.0 - SAMPLE_TEXTURE2D( _Curvaturewear_GrungeMask, sampler_trilinear_repeat, (rotator1_g39623*appendResult38_g39591 + appendResult1168_g39591) ) ) );
				...
				float3 break24_g39600 = ( temp_output_40_0_g39600 - temp_cast_42 );
				...
				float4 smoothstepResult75_g39600 = smoothstep( temp_cast_37 , temp_cast_38 , (float4( 0,0,0,0 ) + (( 1.0 - ( MASK_VERTICAL_X159_g39600 + MASK_VERTICAL_Y157_g39600 + MASK_VERTICAL_Z155_g39600 ) ) - temp_cast_43) * (temp_cast_44 - float4( 0,0,0,0 )) / (float4( 1,1,1,1 ) - temp_cast_43)));
				...
				float4 OUT_NORMAL1178_g38044 = SAMPLE_TEXTURE2D( _BumpMap, sampler_trilinear_repeat, UV40_g39580 );
				float4 temp_output_1_0_g39549 = OUT_NORMAL1178_g38044;
				...
				float3 temp_output_1478_59_g38044 = unpack52_g39549;
				float3 NORMAL_OUT314_g38044 = temp_output_1478_59_g38044;
				float3 temp_output_16_0_g39547 = NORMAL_OUT314_g38044;
				...
				float3 ADDITIONAL_LIGHT1342_g38044 = localAdditionalLightsFlat60_g39547;
				float3 temp_output_8_0_g39591 = ( temp_output_1478_59_g38044 + ADDITIONAL_LIGHT1342_g38044 );
				...
				float4 _MASK_B1440_g38044 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_trilinear_repeat, UV40_g39580 );
				float4 temp_output_977_0_g39591 = ( _MetallicStrength * _MASK_B1440_g38044 );
				float m_Off1434_g39591 = temp_output_977_0_g39591.x;
				float FINAL_MASKMETALLIC_HORIZONTAL1026_g39591 = _Horizontalwear_Metallic;
				float4 temp_cast_52 = (FINAL_MASKMETALLIC_HORIZONTAL1026_g39591).xxxx;
				float4 lerpResult1439_g39591 = lerp( temp_output_977_0_g39591 , temp_cast_52 , MASK_HORIZONTAL808_g39591);
				...
				float4 lerpResult1553_g39591 = lerp( METALLIC_IN1555_g39591 , temp_cast_55 , _Curvaturewear_BlendMix);
				float4 FINAL_MASKMETALLIC_CURVATURE1022_g39591 = lerpResult1553_g39591;
				float4 temp_cast_56 = (localfloatswitch1435_g39591).xxxx;
				float4 lerpResult1437_g39591 = lerp( FINAL_MASKMETALLIC_CURVATURE1022_g39591 , temp_cast_56 , MASK_CURVATURE401_g39591);
				...
				float3 NORMAL_WORLD_OUT164_g38044 = temp_output_1478_59_g38044;
				float3 temp_output_4_0_g39551 = NORMAL_WORLD_OUT164_g38044;
				...
				float4 break377_g38044 = OUT_ALBEDO_RGBA1177_g38044;
				float ALBEDO_R169_g38044 = break377_g38044.r;
				float4 temp_cast_61 = (ALBEDO_R169_g38044).xxxx;
				...
				float4 _MASK_G1438_g38044 = SAMPLE_TEXTURE2D( _SmoothnessMap, sampler_trilinear_repeat, UV40_g39580 );
				float4 temp_output_83_0_g39551 = _MASK_G1438_g38044;
				...
				float4 temp_output_1267_33_g38044 = localfloat4switch99_g39551;
				float4 color301_g38044 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 _MASK_R1439_g38044 = SAMPLE_TEXTURE2D( _OcclusionMap, sampler_trilinear_repeat, UV40_g39580 );
				float4 temp_cast_63 = (IN.ase_color.a).xxxx;
				float4 lerpResult11_g38044 = lerp( _MASK_R1439_g38044 , temp_cast_63 , (float)_OcclusionSourceMode);
				float4 lerpResult14_g38044 = lerp( color301_g38044 , lerpResult11_g38044 , _OcclusionStrengthAO);
				float4 temp_output_989_0_g39591 = ( temp_output_1267_33_g38044 * lerpResult14_g38044 );
				...
				float4 temp_cast_67 = (FINAL_MASKSMOOTHNESS_HORIZONTAL1025_g39591).xxxx;
				float4 lerpResult1030_g39591 = lerp( temp_output_989_0_g39591 , temp_cast_67 , MASK_HORIZONTAL808_g39591);
				...
				float4 lerpResult1552_g39591 = lerp( SMOOTHNESS_IN1554_g39591 , temp_cast_70 , _Curvaturewear_BlendMix);
				float4 FINAL_MASKSMOOTHNESS_CURVATURE1021_g39591 = lerpResult1552_g39591;
				float4 temp_cast_71 = (localfloatswitch1432_g39591).xxxx;
				float4 lerpResult1031_g39591 = lerp( FINAL_MASKSMOOTHNESS_CURVATURE1021_g39591 , temp_cast_71 , MASK_CURVATURE401_g39591);
				...
				float Occlusion = saturate( lerpResult14_g38044 ).r;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult150_g38044 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38044 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39586 = IN.ase_texcoord4.xy * appendResult150_g38044 + appendResult151_g38044;
				float2 appendResult6_g39586 = (float2(texCoord2_g39586.x , texCoord2_g39586.y));
				float2 OUT_UV431_g38044 = appendResult6_g39586;
				float2 UV40_g39580 = OUT_UV431_g38044;
				float4 tex2DNode63_g39580 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g39580 );
				...
				int _Horizontalwear_Mode1003_g39591 = _Horizontalwear_Mode;
				int m_switch1476_g39591 = _Horizontalwear_Mode1003_g39591;
				float2 texCoord794_g39591 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39614 = cos( radians( _Horizontalwear_Rotation ) );
				float sin1_g39614 = sin( radians( _Horizontalwear_Rotation ) );
				float2 rotator1_g39614 = mul( texCoord794_g39591 - float2( 0.5,0.5 ) , float2x2( cos1_g39614 , -sin1_g39614 , sin1_g39614 , cos1_g39614 )) + float2( 0.5,0.5 );
				float2 appendResult811_g39591 = (float2(_Horizontalwear_TilingXMask , _Horizontalwear_TilingYMask));
				...
				int _Verticalwear_Mode1004_g39591 = _Verticalwear_Mode;
				int m_switch1400_g39591 = _Verticalwear_Mode1004_g39591;
				float2 texCoord1584_g39591 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39608 = cos( radians( _Verticalwear_Rotation ) );
				float sin1_g39608 = sin( radians( _Verticalwear_Rotation ) );
				float2 rotator1_g39608 = mul( texCoord1584_g39591 - float2( 0.5,0.5 ) , float2x2( cos1_g39608 , -sin1_g39608 , sin1_g39608 , cos1_g39608 )) + float2( 0.5,0.5 );
				float2 appendResult41_g39591 = (float2(_Verticalwear_TilingXMask , _Verticalwear_TilingYMask));
				...
				int _Curvaturewear_Mode398_g39591 = _Curvaturewear_Mode;
				int m_switch1491_g39591 = _Curvaturewear_Mode398_g39591;
				float2 texCoord28_g39591 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float cos1_g39623 = cos( radians( _Curvaturewear_Rotation ) );
				float sin1_g39623 = sin( radians( _Curvaturewear_Rotation ) );
				float2 rotator1_g39623 = mul( texCoord28_g39591 - float2( 0.5,0.5 ) , float2x2( cos1_g39623 , -sin1_g39623 , sin1_g39623 , cos1_g39623 )) + float2( 0.5,0.5 );
				float2 appendResult38_g39591 = (float2(_Curvaturewear_TilingXMask , _Curvaturewear_TilingYMask));
...
/*ASEBEGIN
Version=18913
4;29.33333;1436;766;38.66374;1331.129;1.64428;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;295;1390.783,-1047.665;Inherit;False;186;125;;1;379;GLOBAL SETTINGS ;0.09433961,0.09433961,0.09433961,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;386;1378.703,-386.772;Inherit;False;310.6667;114;DESF Common ASE Compile Shaders;1;387;;0,0.2047877,1,1;0;0
Node;AmplifyShaderEditor.FunctionNode;389;592.7026,-682.772;Inherit;False;DESF Core Surface;3;;38044;c3df20d62907cd04086a1eacc41e29d1;19,1352,2,183,2,1382,0,1432,1,1433,1,1434,1,1491,0,1284,2,1446,0,307,0,312,0,1318,0,249,0,1319,0,1336,0,1337,0,1407,0,1443,0,1444,0;2;309;FLOAT3;0,0,0;False;1262;FLOAT4;0,0,0,0;False;10;FLOAT4;42;FLOAT3;39;FLOAT3;1473;COLOR;0;FLOAT4;41;COLOR;43;FLOAT;180;FLOAT;55;FLOAT;281;FLOAT3;313
Node;AmplifyShaderEditor.IntNode;379;1412.669,-1009.518;Inherit;False;Property;_CullMode;Cull Mode;2;2;[Header];[Enum];Create;False;1;GLOBAL SETTINGS;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;False;0;1;INT;0
...
WireConnection;388;6;389;42
WireConnection;388;8;389;39
WireConnection;388;977;389;0
WireConnection;388;989;389;41
WireConnection;374;0;388;0
WireConnection;374;1;388;9
WireConnection;374;3;388;991
WireConnection;374;4;388;990
WireConnection;374;5;389;43
ASEEND*/
//CHKSM=1AD047AC62B082BA78E5155613B76E57F244E85C