...
Shader "DEC/Rain/Rain Water Lake Simple"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float floatswitch1190_g39419( int m_switch, float m_Off, float m_Active )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float3 float3switch914_g39419( int m_switch, float3 m_Standard, float3 m_Stochastic )
			{
				if(m_switch ==0)
					return m_Standard;
				else if(m_switch ==1)
			...
			float floatswitch1186_g39419( int m_switch, float m_Off, float m_Active )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float3 float3switch992_g39419( int m_switch, float3 m_Standard, float3 m_Stochastic )
			{
				if(m_switch ==0)
					return m_Standard;
				else if(m_switch ==1)
			...
			float floatswitch1179_g39419( int m_switch, float m_Off, float m_Active )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float3 float3switch1505_g39419( int m_switch, float3 m_Standard, float3 m_Stochastic )
			{
				if(m_switch ==0)
					return m_Standard;
				else if(m_switch ==1)
						 ...
						 ) : SV_Target
			{
				...
				float screenDepth2_g3636 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth2_g3636 = abs( ( screenDepth2_g3636 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _ShorelineDepth ) );
				float4 lerpResult25_g3636 = lerp( _ShorelineTint , _MidwaterTint , saturate( (distanceDepth2_g3636*1.0 + _ShorelineOffset) ));
				float4 lerpResult27_g3636 = lerp( _DepthTint , lerpResult25_g3636 , saturate( (distanceDepth2_g3636*-1.0 + _DepthOffset) ));
				float4 COLOR_TINT161_g3636 = lerpResult27_g3636;
				...
				float2 weightedBlendVar1711_g3636 = IN.ase_texcoord7.xy;
				float3 weightedBlend1711_g3636 = ( weightedBlendVar1711_g3636.x*localfloat3switch238_g38135 + weightedBlendVar1711_g3636.y*localfloat3switch456_g38116 );
				float3 NORMAL_IN84_g38163 = ( weightedBlend1711_g3636 * 10.0 );
				...
				float4 REFRACTED_DEPTH144_g3636 = fetchOpaqueVal89_g38163;
				float temp_output_20_0_g3636 = ( IN.ase_color.a * ( 1.0 - _Opacity ) );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch37_g3636 = 0.0;
				#else
				float staticSwitch37_g3636 = ( 1.0 - ( ( 1.0 - saturate( ( _OpacityShoreline * (distanceDepth2_g3636*-5.0 + 1.0) ) ) ) * temp_output_20_0_g3636 ) );
				#endif
				float DEPTH_TINT_ALPHA93_g3636 = staticSwitch37_g3636;
				float4 lerpResult105_g3636 = lerp( COLOR_TINT161_g3636 , REFRACTED_DEPTH144_g3636 , DEPTH_TINT_ALPHA93_g3636);
				...
				float GRAB_SCREEN_DEPTH_BEHIND80_g3636 = saturate( temp_output_13_0_g38130 );
				float4 temp_cast_20 = (GRAB_SCREEN_DEPTH_BEHIND80_g3636).xxxx;
				...
				float GRAB_SCREEN_DEPTH73_g3636 = localCorrectedLinearEyeDepth1_g38130;
				float4 temp_cast_21 = (GRAB_SCREEN_DEPTH73_g3636).xxxx;
				float4 GRAB_SCREEN_DEPTH310_g38104 = temp_cast_21;
				float4 temp_cast_22 = (0.001).xxxx;
				float GRAB_SCREEN_CLOSENESS83_g3636 = saturate( ( 1.0 / distance( _WorldSpaceCameraPos , WorldPosition ) ) );
				float4 temp_cast_23 = (GRAB_SCREEN_CLOSENESS83_g3636).xxxx;
				...
				float4 FOAM_VERTICAL_OFFSHORE655_g3636 = temp_output_1189_0_g38104;
				...
				float4 temp_cast_32 = (GRAB_SCREEN_DEPTH_BEHIND80_g3636).xxxx;
				...
				float4 temp_cast_33 = (GRAB_SCREEN_DEPTH73_g3636).xxxx;
				float4 GRAB_SCREEN_DEPTH310_g38156 = temp_cast_33;
				float4 temp_cast_34 = (0.001).xxxx;
				float4 temp_cast_35 = (GRAB_SCREEN_CLOSENESS83_g3636).xxxx;
				...
				float4 FOAM_HORIZONTAL_OFFSHORE1565_g3636 = temp_output_1188_0_g38156;
				...
				float4 temp_cast_43 = (GRAB_SCREEN_DEPTH_BEHIND80_g3636).xxxx;
				...
				float4 temp_cast_44 = (GRAB_SCREEN_DEPTH73_g3636).xxxx;
				float4 GRAB_SCREEN_DEPTH310_g38145 = temp_cast_44;
				float4 temp_cast_45 = (0.4125228).xxxx;
				float4 temp_cast_46 = (GRAB_SCREEN_CLOSENESS83_g3636).xxxx;
				...
				float4 FOAM_SHORELINE654_g3636 = lerpResult761_g38145;
				float4 temp_output_1492_0_g3636 = ( ( ( lerpResult105_g3636 + FOAM_VERTICAL_OFFSHORE655_g3636 ) + FOAM_HORIZONTAL_OFFSHORE1565_g3636 ) + FOAM_SHORELINE654_g3636 );
				float4 temp_output_746_0_g39419 = temp_output_1492_0_g3636;
				
				int m_switch103_g39419 = _Vertical_RainMode;
				...
				float3 FOAM_VERTICAL_OFFSHORE_NORMAL1192_g3636 = localfloat3switch1246_g38104;
				...
				float3 FOAM_HORIZONTAL_OFFSHORE_NORMAL1564_g3636 = localfloat3switch1230_g38156;
				...
				float3 FOAM_NORMALShorline1208_g3636 = localfloat3switch1223_g38145;
				float3 temp_output_1715_0_g3636 = BlendNormal( BlendNormal( BlendNormal( weightedBlend1711_g3636 , FOAM_VERTICAL_OFFSHORE_NORMAL1192_g3636 ) , FOAM_HORIZONTAL_OFFSHORE_NORMAL1564_g3636 ) , FOAM_NORMALShorline1208_g3636 );
				float3 worldPosValue71_g38152 = WorldPosition;
				float3 WorldPosition52_g38152 = worldPosValue71_g38152;
				float3 NORMAL_OUT1731_g3636 = temp_output_1715_0_g3636;
				float3 temp_output_16_0_g38152 = NORMAL_OUT1731_g3636;
				...
				float3 ADDITIONAL_LIGHT1730_g3636 = localAdditionalLightsSpecular52_g38152;
				float3 temp_output_1732_0_g3636 = ( temp_output_1715_0_g3636 + ADDITIONAL_LIGHT1730_g3636 );
				float3 temp_output_19_0_g39419 = temp_output_1732_0_g3636;
				float3 NORMAL_IN105_g39419 = temp_output_19_0_g39419;
				float3 m_Off103_g39419 = NORMAL_IN105_g39419;
				int m_switch914_g39419 = _Vertical_ModeUV;
				float3 _MASK_VECTOR1485_g39419 = float3(0.001,0.001,0.001);
				float2 appendResult259_g39419 = (float2(_Vertical_TilingX , _Vertical_TilingY));
				float2 VERTICAL_UV_TILING377_g39419 = appendResult259_g39419;
				float2 UV_TILING88_g39466 = VERTICAL_UV_TILING377_g39419;
				float3 objToWorld137_g39466 = mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord9.xyz, 1 ) ).xyz;
				...
				float temp_output_36_0_g39466 = frac( ( ( ( _TimeParameters.x * _Vertical_Speed ) + clampResult37_g39466 ) / VERTICAL_FRAMES15_g39466 ) );
				float2 appendResult31_g39466 = (float2(temp_output_36_0_g39466 , ( 1.0 - temp_output_36_0_g39466 )));
				float2 _UV_VERTICAL_X_DOWN863_g39419 = ( ( ( ( UV_TILING88_g39466 * appendResult129_g39466 ) + ( (ase_screenPosNorm).xy * _Vertical_ScreenContribution ) ) / appendResult1_g39466 ) + ( floor( ( appendResult49_g39466 * appendResult31_g39466 ) ) / appendResult1_g39466 ) );
				int _Global_Rain_Enabled1178_g39419 = _Global_Rain_Enabled;
				int m_switch1190_g39419 = _Global_Rain_Enabled1178_g39419;
				float m_Off1190_g39419 = _Vertical_Intensity;
				float _Global_Rain_Intensity1174_g39419 = _Global_Rain_Intensity;
				float m_Active1190_g39419 = ( _Vertical_Intensity * _Global_Rain_Intensity1174_g39419 );
				float localfloatswitch1190_g39419 = floatswitch1190_g39419( m_switch1190_g39419 , m_Off1190_g39419 , m_Active1190_g39419 );
				float _VERTICAL_INTENSITY861_g39419 = saturate( localfloatswitch1190_g39419 );
				float3 unpack908_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D( _Vertical_RainMap, sampler_trilinear_repeat, _UV_VERTICAL_X_DOWN863_g39419 ), _VERTICAL_INTENSITY861_g39419 );
				unpack908_g39419.z = lerp( 1, unpack908_g39419.z, saturate(_VERTICAL_INTENSITY861_g39419) );
				float3 temp_cast_57 = (0.5).xxx;
				float3 break149_g39419 = ( abs( WorldNormal ) - temp_cast_57 );
				float smoothstepResult1521_g39419 = smoothstep( _Vertical_SmoothEdge , 1.0 , ( break149_g39419.z + 0.5 ));
				float _MASK_VERTICAL_Z1241_g39419 = smoothstepResult1521_g39419;
				float3 lerpResult1138_g39419 = lerp( _MASK_VECTOR1485_g39419 , unpack908_g39419 , _MASK_VERTICAL_Z1241_g39419);
				float2 UV_TILING88_g39452 = VERTICAL_UV_TILING377_g39419;
				float3 objToWorld137_g39452 = mul( GetObjectToWorldMatrix(), float4( IN.ase_texcoord9.xyz, 1 ) ).xyz;
				...
				float temp_output_36_0_g39452 = frac( ( ( ( _TimeParameters.x * _Vertical_Speed ) + clampResult37_g39452 ) / VERTICAL_FRAMES15_g39452 ) );
				float2 appendResult31_g39452 = (float2(temp_output_36_0_g39452 , ( 1.0 - temp_output_36_0_g39452 )));
				float2 _UV_VERTICAL_Y_DOWN870_g39419 = ( ( ( ( UV_TILING88_g39452 * appendResult115_g39452 ) + ( (ase_screenPosNorm).xy * _Vertical_ScreenContribution ) ) / appendResult1_g39452 ) + ( floor( ( appendResult49_g39452 * appendResult31_g39452 ) ) / appendResult1_g39452 ) );
				float3 unpack925_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D( _Vertical_RainMap, sampler_trilinear_repeat, _UV_VERTICAL_Y_DOWN870_g39419 ), _VERTICAL_INTENSITY861_g39419 );
				unpack925_g39419.z = lerp( 1, unpack925_g39419.z, saturate(_VERTICAL_INTENSITY861_g39419) );
				float2 _SmoothX = float2(0,1);
				float smoothstepResult1523_g39419 = smoothstep( _SmoothX.x , _SmoothX.y , ( break149_g39419.x + 0.45 ));
				float _MASK_VERTICAL_X151_g39419 = smoothstepResult1523_g39419;
				float3 lerpResult1261_g39419 = lerp( _MASK_VECTOR1485_g39419 , unpack925_g39419 , _MASK_VERTICAL_X151_g39419);
				float2 _SmoothY = float2(0,1);
				float smoothstepResult1519_g39419 = smoothstep( _SmoothY.x , _SmoothY.y , ( -break149_g39419.y + 0.45 ));
				float _MASK_VERTICAL_Y1216_g39419 = smoothstepResult1519_g39419;
				float3 lerpResult1390_g39419 = lerp( lerpResult1138_g39419 , BlendNormal( lerpResult1138_g39419 , lerpResult1261_g39419 ) , _MASK_VERTICAL_Y1216_g39419);
				float3 m_Standard914_g39419 = lerpResult1390_g39419;
				float localStochasticTiling895_g39419 = ( 0.0 );
				float2 UV895_g39419 = _UV_VERTICAL_X_DOWN863_g39419;
				float2 UV1895_g39419 = float2( 0,0 );
				float2 UV2895_g39419 = float2( 0,0 );
				float2 UV3895_g39419 = float2( 0,0 );
				float W1895_g39419 = 0.0;
				float W2895_g39419 = 0.0;
				float W3895_g39419 = 0.0;
				StochasticTiling( UV895_g39419 , UV1895_g39419 , UV2895_g39419 , UV3895_g39419 , W1895_g39419 , W2895_g39419 , W3895_g39419 );
				float2 temp_output_906_0_g39419 = ddx( _UV_VERTICAL_X_DOWN863_g39419 );
				float2 temp_output_886_0_g39419 = ddy( _UV_VERTICAL_X_DOWN863_g39419 );
				float3 unpack913_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Vertical_RainMap, sampler_trilinear_repeat, UV1895_g39419, temp_output_906_0_g39419, temp_output_886_0_g39419 ), _VERTICAL_INTENSITY861_g39419 );
				unpack913_g39419.z = lerp( 1, unpack913_g39419.z, saturate(_VERTICAL_INTENSITY861_g39419) );
				float UV1_V1_W1887_g39419 = W1895_g39419;
				float3 unpack920_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Vertical_RainMap, sampler_trilinear_repeat, UV2895_g39419, temp_output_906_0_g39419, temp_output_886_0_g39419 ), _VERTICAL_INTENSITY861_g39419 );
				unpack920_g39419.z = lerp( 1, unpack920_g39419.z, saturate(_VERTICAL_INTENSITY861_g39419) );
				float UV1_V1_W2897_g39419 = W2895_g39419;
				float3 unpack892_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Vertical_RainMap, sampler_trilinear_repeat, UV3895_g39419, temp_output_906_0_g39419, temp_output_886_0_g39419 ), _VERTICAL_INTENSITY861_g39419 );
				unpack892_g39419.z = lerp( 1, unpack892_g39419.z, saturate(_VERTICAL_INTENSITY861_g39419) );
				float UV1_V1_W3926_g39419 = W3895_g39419;
				float3 lerpResult950_g39419 = lerp( _MASK_VECTOR1485_g39419 , ( ( unpack913_g39419 * UV1_V1_W1887_g39419 ) + ( ( unpack920_g39419 * UV1_V1_W2897_g39419 ) + ( unpack892_g39419 * UV1_V1_W3926_g39419 ) ) ) , _MASK_VERTICAL_Z1241_g39419);
				float localStochasticTiling865_g39419 = ( 0.0 );
				float2 UV865_g39419 = _UV_VERTICAL_Y_DOWN870_g39419;
				float2 UV1865_g39419 = float2( 0,0 );
				float2 UV2865_g39419 = float2( 0,0 );
				float2 UV3865_g39419 = float2( 0,0 );
				float W1865_g39419 = 0.0;
				float W2865_g39419 = 0.0;
				float W3865_g39419 = 0.0;
				StochasticTiling( UV865_g39419 , UV1865_g39419 , UV2865_g39419 , UV3865_g39419 , W1865_g39419 , W2865_g39419 , W3865_g39419 );
				float2 temp_output_883_0_g39419 = ddx( _UV_VERTICAL_Y_DOWN870_g39419 );
				float2 temp_output_894_0_g39419 = ddy( _UV_VERTICAL_Y_DOWN870_g39419 );
				float3 unpack904_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Vertical_RainMap, sampler_trilinear_repeat, UV1865_g39419, temp_output_883_0_g39419, temp_output_894_0_g39419 ), _VERTICAL_INTENSITY861_g39419 );
				unpack904_g39419.z = lerp( 1, unpack904_g39419.z, saturate(_VERTICAL_INTENSITY861_g39419) );
				float UV1_V2_W1866_g39419 = W1865_g39419;
				float3 unpack922_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Vertical_RainMap, sampler_trilinear_repeat, UV2865_g39419, temp_output_883_0_g39419, temp_output_894_0_g39419 ), _VERTICAL_INTENSITY861_g39419 );
				unpack922_g39419.z = lerp( 1, unpack922_g39419.z, saturate(_VERTICAL_INTENSITY861_g39419) );
				float UV1_V2_W2884_g39419 = W2865_g39419;
				float3 unpack910_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Vertical_RainMap, sampler_trilinear_repeat, UV3865_g39419, temp_output_883_0_g39419, temp_output_894_0_g39419 ), _VERTICAL_INTENSITY861_g39419 );
				unpack910_g39419.z = lerp( 1, unpack910_g39419.z, saturate(_VERTICAL_INTENSITY861_g39419) );
				float UV1_V2_W3871_g39419 = W3865_g39419;
				float3 lerpResult946_g39419 = lerp( _MASK_VECTOR1485_g39419 , ( ( unpack904_g39419 * UV1_V2_W1866_g39419 ) + ( ( unpack922_g39419 * UV1_V2_W2884_g39419 ) + ( unpack910_g39419 * UV1_V2_W3871_g39419 ) ) ) , _MASK_VERTICAL_X151_g39419);
				float3 lerpResult1400_g39419 = lerp( lerpResult950_g39419 , BlendNormal( lerpResult950_g39419 , lerpResult946_g39419 ) , _MASK_VERTICAL_Y1216_g39419);
				float3 m_Stochastic914_g39419 = lerpResult1400_g39419;
				float3 localfloat3switch914_g39419 = float3switch914_g39419( m_switch914_g39419 , m_Standard914_g39419 , m_Stochastic914_g39419 );
				float3 RAIN_VERTICAL127_g39419 = localfloat3switch914_g39419;
				float temp_output_1454_0_g3636 = ( _SMOOTHNESS_Strength * _SMOOTHNESS_Strength );
				float3 temp_cast_58 = (temp_output_1454_0_g3636).xxx;
				float3 NORMAL_OUT_Z505_g3636 = weightedBlend1711_g3636;
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal1601_g3636 = NORMAL_OUT_Z505_g3636;
				float3 worldNormal1601_g3636 = float3(dot(tanToWorld0,tanNormal1601_g3636), dot(tanToWorld1,tanNormal1601_g3636), dot(tanToWorld2,tanNormal1601_g3636));
				float fresnelNdotV1412_g3636 = dot( worldNormal1601_g3636, SafeNormalize(_MainLightPosition.xyz) );
				float fresnelNode1412_g3636 = ( _SMOOTHNESS_FresnelBias + _SMOOTHNESS_FresnelScale * pow( max( 1.0 - fresnelNdotV1412_g3636 , 0.0001 ), _SMOOTHNESS_FresnelPower ) );
				float3 lerpResult1403_g3636 = lerp( temp_cast_58 , ( temp_output_1454_0_g3636 * worldNormal1601_g3636 ) , ( fresnelNode1412_g3636 * ( 1.0 - fresnelNode1412_g3636 ) ));
				float3 clampResult1740_g3636 = clamp( lerpResult1403_g3636 , float3( 0,0,0 ) , float3( 1,1,1 ) );
				float4 temp_output_23_0_g39419 = float4( clampResult1740_g3636 , 0.0 );
				float4 lerpResult144_g39419 = lerp( temp_output_23_0_g39419 , ( temp_output_23_0_g39419 * 0.05 ) , IN.ase_color.r);
				float4 temp_cast_60 = (0.7).xxxx;
				float4 SMOOTHNESS94_g39419 = step( step( lerpResult144_g39419 , temp_cast_60 ) , float4( 0,0,0,0 ) );
				float3 lerpResult42_g39419 = lerp( RAIN_VERTICAL127_g39419 , float3( 0,0,0 ) , SMOOTHNESS94_g39419.xyz);
				float3 temp_output_26_0_g39461 = float3( 0,0,0 );
				float3 m_Active103_g39419 = BlendNormal( temp_output_19_0_g39419 , ( ( lerpResult42_g39419 - temp_output_26_0_g39461 ) / ( float3( 1,1,1 ) - temp_output_26_0_g39461 ) ) );
				float3 localfloat3switch103_g39419 = float3switch( m_switch103_g39419 , m_Off103_g39419 , m_Active103_g39419 );
				int m_switch1010_g39419 = _Static_RainMode;
				float3 m_Off1010_g39419 = NORMAL_IN105_g39419;
				int m_switch992_g39419 = _Static_ModeUV;
				float2 appendResult737_g39419 = (float2(_Static_TilingX , _Static_TilingY));
				float2 appendResult738_g39419 = (float2(_Static_OffsetX , _Static_OffsetY));
				float2 texCoord736_g39419 = IN.ase_texcoord7.xy * appendResult737_g39419 + appendResult738_g39419;
				float2 appendResult731_g39419 = (float2(frac( texCoord736_g39419.x ) , frac( texCoord736_g39419.y )));
				float2 _STATIC_UV01_OUT990_g39419 = ( appendResult731_g39419 + ( (ase_screenPosNorm).xy * _Static_ScreenContribution ) );
				int m_switch1186_g39419 = _Global_Rain_Enabled1178_g39419;
				float m_Off1186_g39419 = _Static_Intensity;
				float m_Active1186_g39419 = ( _Static_Intensity * _Global_Rain_Intensity1174_g39419 );
				float localfloatswitch1186_g39419 = floatswitch1186_g39419( m_switch1186_g39419 , m_Off1186_g39419 , m_Active1186_g39419 );
				float _STATIC_INTENSITY991_g39419 = saturate( localfloatswitch1186_g39419 );
				float3 unpack727_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D( _Static_RainMap, sampler_trilinear_repeat, _STATIC_UV01_OUT990_g39419 ), _STATIC_INTENSITY991_g39419 );
				unpack727_g39419.z = lerp( 1, unpack727_g39419.z, saturate(_STATIC_INTENSITY991_g39419) );
				float3 m_Standard992_g39419 = unpack727_g39419;
				float localStochasticTiling973_g39419 = ( 0.0 );
				float2 UV973_g39419 = _STATIC_UV01_OUT990_g39419;
				float2 UV1973_g39419 = float2( 0,0 );
				float2 UV2973_g39419 = float2( 0,0 );
				float2 UV3973_g39419 = float2( 0,0 );
				float W1973_g39419 = 0.0;
				float W2973_g39419 = 0.0;
				float W3973_g39419 = 0.0;
				StochasticTiling( UV973_g39419 , UV1973_g39419 , UV2973_g39419 , UV3973_g39419 , W1973_g39419 , W2973_g39419 , W3973_g39419 );
				float2 temp_output_977_0_g39419 = ddx( _STATIC_UV01_OUT990_g39419 );
				float2 temp_output_978_0_g39419 = ddy( _STATIC_UV01_OUT990_g39419 );
				float3 unpack974_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Static_RainMap, sampler_trilinear_repeat, UV1973_g39419, temp_output_977_0_g39419, temp_output_978_0_g39419 ), _STATIC_INTENSITY991_g39419 );
				unpack974_g39419.z = lerp( 1, unpack974_g39419.z, saturate(_STATIC_INTENSITY991_g39419) );
				float UV1_S1_W1975_g39419 = W1973_g39419;
				float3 unpack970_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Static_RainMap, sampler_trilinear_repeat, UV2973_g39419, temp_output_977_0_g39419, temp_output_978_0_g39419 ), _STATIC_INTENSITY991_g39419 );
				unpack970_g39419.z = lerp( 1, unpack970_g39419.z, saturate(_STATIC_INTENSITY991_g39419) );
				float UV1_S1_W2972_g39419 = W2973_g39419;
				float3 unpack971_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Static_RainMap, sampler_trilinear_repeat, UV3973_g39419, temp_output_977_0_g39419, temp_output_978_0_g39419 ), _STATIC_INTENSITY991_g39419 );
				unpack971_g39419.z = lerp( 1, unpack971_g39419.z, saturate(_STATIC_INTENSITY991_g39419) );
				float UV1_S1_W3976_g39419 = W3973_g39419;
				float3 m_Stochastic992_g39419 = ( ( unpack974_g39419 * UV1_S1_W1975_g39419 ) + ( ( unpack970_g39419 * UV1_S1_W2972_g39419 ) + ( unpack971_g39419 * UV1_S1_W3976_g39419 ) ) );
				float3 localfloat3switch992_g39419 = float3switch992_g39419( m_switch992_g39419 , m_Standard992_g39419 , m_Stochastic992_g39419 );
				float3 RAIN_STATIC743_g39419 = localfloat3switch992_g39419;
				float3 lerpResult1005_g39419 = lerp( RAIN_STATIC743_g39419 , float3( 0,0,0 ) , SMOOTHNESS94_g39419.xyz);
				float3 temp_output_26_0_g39472 = float3( 0,0,0 );
				float3 m_Active1010_g39419 = BlendNormal( temp_output_19_0_g39419 , ( ( lerpResult1005_g39419 - temp_output_26_0_g39472 ) / ( float3( 1,1,1 ) - temp_output_26_0_g39472 ) ) );
				float3 localfloat3switch1010_g39419 = float3switch( m_switch1010_g39419 , m_Off1010_g39419 , m_Active1010_g39419 );
				int m_switch1009_g39419 = _Horizontal_RainMode;
				float3 m_Off1009_g39419 = NORMAL_IN105_g39419;
				int m_switch1505_g39419 = _Horizontal_ModeUV;
				float2 appendResult269_g39419 = (float2(_Horizontal_TilingX , _Horizontal_TilingY));
				float2 HORIZONTAL_UV_TILING158_g39419 = appendResult269_g39419;
				float2 UV_TILING88_g39470 = HORIZONTAL_UV_TILING158_g39419;
				float2 appendResult271_g39419 = (float2(_Horizontal_OffsetX , _Horizontal_OffsetY));
				float2 HORIZONTAL_UV_OFFSET159_g39419 = appendResult271_g39419;
				float2 UV_OFFSET94_g39470 = HORIZONTAL_UV_OFFSET159_g39419;
				float2 texCoord87_g39470 = IN.ase_texcoord7.xy * UV_TILING88_g39470 + UV_OFFSET94_g39470;
				float2 appendResult86_g39470 = (float2(frac( texCoord87_g39470.x ) , frac( texCoord87_g39470.y )));
				...
				float temp_output_36_0_g39470 = frac( ( ( ( _TimeParameters.x * _Horizontal_Speed ) + clampResult37_g39470 ) / VERTICAL_FRAMES15_g39470 ) );
				float2 appendResult31_g39470 = (float2(temp_output_36_0_g39470 , ( 1.0 - temp_output_36_0_g39470 )));
				float2 UV_HORIZONTAL_DEFAULT_01817_g39419 = ( ( ( appendResult86_g39470 + ( (ase_screenPosNorm).xy * _Horizontal_ScreenContribution ) ) / appendResult1_g39470 ) + ( floor( ( appendResult49_g39470 * appendResult31_g39470 ) ) / appendResult1_g39470 ) );
				int m_switch1179_g39419 = _Global_Rain_Enabled1178_g39419;
				float m_Off1179_g39419 = _Horizontal_Intensity;
				float m_Active1179_g39419 = ( _Horizontal_Intensity * _Global_Rain_Intensity1174_g39419 );
				float localfloatswitch1179_g39419 = floatswitch1179_g39419( m_switch1179_g39419 , m_Off1179_g39419 , m_Active1179_g39419 );
				float _HORIZONTAL_INTENSITY814_g39419 = saturate( localfloatswitch1179_g39419 );
				float3 unpack9_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D( _Horizontal_RainMap, sampler_trilinear_repeat, UV_HORIZONTAL_DEFAULT_01817_g39419 ), _HORIZONTAL_INTENSITY814_g39419 );
				unpack9_g39419.z = lerp( 1, unpack9_g39419.z, saturate(_HORIZONTAL_INTENSITY814_g39419) );
				float2 UV_TILING88_g39454 = ( HORIZONTAL_UV_TILING158_g39419 / float2( 0.6,0.6 ) );
				float2 UV_OFFSET94_g39454 = ( HORIZONTAL_UV_OFFSET159_g39419 + float2( 0.3,0.3 ) );
				float2 texCoord87_g39454 = IN.ase_texcoord7.xy * UV_TILING88_g39454 + UV_OFFSET94_g39454;
				float2 appendResult86_g39454 = (float2(frac( texCoord87_g39454.x ) , frac( texCoord87_g39454.y )));
				...
				float temp_output_36_0_g39454 = frac( ( ( ( _TimeParameters.x * _Horizontal_Speed ) + clampResult37_g39454 ) / VERTICAL_FRAMES15_g39454 ) );
				float2 appendResult31_g39454 = (float2(temp_output_36_0_g39454 , ( 1.0 - temp_output_36_0_g39454 )));
				float2 UV_HORIZONTAL_DEFAULT_02818_g39419 = ( ( ( appendResult86_g39454 + ( (ase_screenPosNorm).xy * _Horizontal_ScreenContribution ) ) / appendResult1_g39454 ) + ( floor( ( appendResult49_g39454 * appendResult31_g39454 ) ) / appendResult1_g39454 ) );
				float3 unpack339_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D( _Horizontal_RainMap, sampler_trilinear_repeat, UV_HORIZONTAL_DEFAULT_02818_g39419 ), _HORIZONTAL_INTENSITY814_g39419 );
				unpack339_g39419.z = lerp( 1, unpack339_g39419.z, saturate(_HORIZONTAL_INTENSITY814_g39419) );
				float3 m_Standard1505_g39419 = BlendNormal( unpack9_g39419 , unpack339_g39419 );
				float localStochasticTiling800_g39419 = ( 0.0 );
				float2 UV800_g39419 = UV_HORIZONTAL_DEFAULT_01817_g39419;
				float2 UV1800_g39419 = float2( 0,0 );
				float2 UV2800_g39419 = float2( 0,0 );
				float2 UV3800_g39419 = float2( 0,0 );
				float W1800_g39419 = 0.0;
				float W2800_g39419 = 0.0;
				float W3800_g39419 = 0.0;
				StochasticTiling( UV800_g39419 , UV1800_g39419 , UV2800_g39419 , UV3800_g39419 , W1800_g39419 , W2800_g39419 , W3800_g39419 );
				float2 temp_output_804_0_g39419 = ddx( UV_HORIZONTAL_DEFAULT_01817_g39419 );
				float2 temp_output_797_0_g39419 = ddy( UV_HORIZONTAL_DEFAULT_01817_g39419 );
				float3 unpack809_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Horizontal_RainMap, sampler_trilinear_repeat, UV1800_g39419, temp_output_804_0_g39419, temp_output_797_0_g39419 ), _HORIZONTAL_INTENSITY814_g39419 );
				unpack809_g39419.z = lerp( 1, unpack809_g39419.z, saturate(_HORIZONTAL_INTENSITY814_g39419) );
				float UV1_H1_W1805_g39419 = W1800_g39419;
				float3 unpack810_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Horizontal_RainMap, sampler_trilinear_repeat, UV2800_g39419, temp_output_804_0_g39419, temp_output_797_0_g39419 ), _HORIZONTAL_INTENSITY814_g39419 );
				unpack810_g39419.z = lerp( 1, unpack810_g39419.z, saturate(_HORIZONTAL_INTENSITY814_g39419) );
				float UV1_H1_W2803_g39419 = W2800_g39419;
				float3 unpack811_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Horizontal_RainMap, sampler_trilinear_repeat, UV3800_g39419, temp_output_804_0_g39419, temp_output_797_0_g39419 ), _HORIZONTAL_INTENSITY814_g39419 );
				unpack811_g39419.z = lerp( 1, unpack811_g39419.z, saturate(_HORIZONTAL_INTENSITY814_g39419) );
				float UV1_H1_W3812_g39419 = W3800_g39419;
				float localStochasticTiling781_g39419 = ( 0.0 );
				float2 UV781_g39419 = UV_HORIZONTAL_DEFAULT_02818_g39419;
				float2 UV1781_g39419 = float2( 0,0 );
				float2 UV2781_g39419 = float2( 0,0 );
				float2 UV3781_g39419 = float2( 0,0 );
				float W1781_g39419 = 0.0;
				float W2781_g39419 = 0.0;
				float W3781_g39419 = 0.0;
				StochasticTiling( UV781_g39419 , UV1781_g39419 , UV2781_g39419 , UV3781_g39419 , W1781_g39419 , W2781_g39419 , W3781_g39419 );
				float2 temp_output_788_0_g39419 = ddx( UV_HORIZONTAL_DEFAULT_02818_g39419 );
				float2 temp_output_777_0_g39419 = ddy( UV_HORIZONTAL_DEFAULT_02818_g39419 );
				float3 unpack782_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Horizontal_RainMap, sampler_trilinear_repeat, UV1781_g39419, temp_output_788_0_g39419, temp_output_777_0_g39419 ), _HORIZONTAL_INTENSITY814_g39419 );
				unpack782_g39419.z = lerp( 1, unpack782_g39419.z, saturate(_HORIZONTAL_INTENSITY814_g39419) );
				float UV1_H2_W1789_g39419 = W1781_g39419;
				float3 unpack783_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Horizontal_RainMap, sampler_trilinear_repeat, UV2781_g39419, temp_output_788_0_g39419, temp_output_777_0_g39419 ), _HORIZONTAL_INTENSITY814_g39419 );
				unpack783_g39419.z = lerp( 1, unpack783_g39419.z, saturate(_HORIZONTAL_INTENSITY814_g39419) );
				float UV1_H2_W2787_g39419 = W2781_g39419;
				float3 unpack779_g39419 = UnpackNormalScale( SAMPLE_TEXTURE2D_GRAD( _Horizontal_RainMap, sampler_trilinear_repeat, UV3781_g39419, temp_output_788_0_g39419, temp_output_777_0_g39419 ), _HORIZONTAL_INTENSITY814_g39419 );
				unpack779_g39419.z = lerp( 1, unpack779_g39419.z, saturate(_HORIZONTAL_INTENSITY814_g39419) );
				float UV1_H2_W3785_g39419 = W3781_g39419;
				float3 m_Stochastic1505_g39419 = BlendNormal( ( ( unpack809_g39419 * UV1_H1_W1805_g39419 ) + ( ( unpack810_g39419 * UV1_H1_W2803_g39419 ) + ( unpack811_g39419 * UV1_H1_W3812_g39419 ) ) ) , ( ( unpack782_g39419 * UV1_H2_W1789_g39419 ) + ( ( unpack783_g39419 * UV1_H2_W2787_g39419 ) + ( unpack779_g39419 * UV1_H2_W3785_g39419 ) ) ) );
				float3 localfloat3switch1505_g39419 = float3switch1505_g39419( m_switch1505_g39419 , m_Standard1505_g39419 , m_Stochastic1505_g39419 );
				float2 _SmoothH = float2(0,1);
				float smoothstepResult1517_g39419 = smoothstep( _SmoothH.x , _SmoothH.y , ( WorldNormal.y + 0.02 ));
				float _MASK_HORIZONTAL152_g39419 = smoothstepResult1517_g39419;
				float3 lerpResult279_g39419 = lerp( _MASK_VECTOR1485_g39419 , localfloat3switch1505_g39419 , _MASK_HORIZONTAL152_g39419);
				float3 RAIN_HORIZONTAL123_g39419 = lerpResult279_g39419;
				float3 lerpResult1002_g39419 = lerp( RAIN_HORIZONTAL123_g39419 , float3( 0,0,0 ) , SMOOTHNESS94_g39419.xyz);
				float3 temp_output_26_0_g39463 = float3( 0,0,0 );
				float3 m_Active1009_g39419 = BlendNormal( temp_output_19_0_g39419 , ( ( lerpResult1002_g39419 - temp_output_26_0_g39463 ) / ( float3( 1,1,1 ) - temp_output_26_0_g39463 ) ) );
				float3 localfloat3switch1009_g39419 = float3switch( m_switch1009_g39419 , m_Off1009_g39419 , m_Active1009_g39419 );
				...
				float3 tanNormal37_g38128 = temp_output_1732_0_g3636;
				...
				float4 temp_output_17_0_g39460 = temp_output_23_0_g39419;
				...
				float3 Albedo = ( temp_output_746_0_g39419 * ( 1.0 - _Rain_WetnessDarken ) ).xyz;
				float3 Normal = ( localfloat3switch103_g39419 + localfloat3switch1010_g39419 + localfloat3switch1009_g39419 );
				float3 Emission = 0;
				float3 Specular = localfloat3switch18_g38128;
				float Metallic = 0;
				float Smoothness = localfloat4switch23_g39460.x;
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 m_FlowMap456_g38116 = lerpResult411_g38116;
				float3 localfloat3switch456_g38116 = float3switch456_g38116( m_switch456_g38116 , m_Off456_g38116 , m_Swirling456_g38116 , m_FlowMap456_g38116 );
				float2 weightedBlendVar1711_g3636 = IN.ase_texcoord3.xy;
				float3 weightedBlend1711_g3636 = ( weightedBlendVar1711_g3636.x*localfloat3switch238_g38135 + weightedBlendVar1711_g3636.y*localfloat3switch456_g38116 );
				float3 NORMAL_IN84_g38163 = ( weightedBlend1711_g3636 * 10.0 );
				float REFACTED_SCALE_FLOAT78_g38163 = _RefractionScale;
...
/*ASEBEGIN
Version=18913
4;29.33333;1436;766;707.8929;3201.562;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;843;202.0305,-3227.07;Inherit;False;155;129;;1;207;GLOBAL SETTINGS ;0,0,0,1;0;0
Node;AmplifyShaderEditor.FunctionNode;971;-644.5254,-2847.154;Inherit;False;DESF Core Water URP;4;;3636;2ce30b88128d2f64bb175b3da03ff631;9,1745,6,169,0,212,1,1081,0,440,0,438,0,1078,0,310,0,1079,0;0;7;COLOR;0;FLOAT3;123;FLOAT3;1651;FLOAT3;122;FLOAT;419;FLOAT;417;FLOAT;1080
Node;AmplifyShaderEditor.CommentaryNode;972;190.768,-2578.783;Inherit;False;310.2667;116.7998;DESF Common ASE Compile Shaders;1;973;;0,0.2047877,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;844;199.208,-3064.666;Inherit;False;347.5028;191.4201;;3;698;964;700;DEBUG SETTINGS ;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.IntNode;207;216.0131,-3187.746;Float;False;Property;_CullMode;Cull Mode;3;2;[Header];[Enum];Create;True;1;GLOBAL SETTINGS;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;973;203.968,-2538.383;Inherit;False;DESF Common ASE Compile Shaders;-1;;39418;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;700;390.9788,-3023.781;Inherit;False;Property;_ZWriteMode;ZWrite Mode;0;2;[Header];[Enum];Create;False;1;DEBUG SETTINGS;0;1;Off,0,On,1;True;0;False;1;1;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;969;-219.5254,-2878.154;Inherit;False;DESF Module Rain;140;;39419;58c64a46e00b7044aaf191f7451a976c;1,1532,1;3;746;FLOAT4;0,0,0,0;False;19;FLOAT3;0,0,1;False;23;FLOAT4;1,0,0,0;False;3;FLOAT4;747;FLOAT3;0;FLOAT4;1536
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;905;198.1309,-2867.459;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;18;all;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;True;698;False;False;False;False;False;False;False;False;False;True;2;True;700;True;3;False;697;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
WireConnection;969;746;971;0
WireConnection;969;19;971;123
WireConnection;969;23;971;122
WireConnection;901;0;969;747
WireConnection;901;1;969;0
WireConnection;901;9;971;1651
WireConnection;901;4;969;1536
ASEEND*/
//CHKSM=644B2F5973C9F908DC748926542939E19F53DC86