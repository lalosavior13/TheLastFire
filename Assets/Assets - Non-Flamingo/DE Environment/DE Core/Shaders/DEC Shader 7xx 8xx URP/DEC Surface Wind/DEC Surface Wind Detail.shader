...
Shader "DEC/Surface Wind/Surface Wind Detail"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float floatswitch2458_g3439( int m_switch, float m_Off, float m_Global, float m_Local )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float floatswitch2468_g3439( int m_switch, float m_Off, float m_Global, float m_Local )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float floatswitch2312_g3439( int m_switch, float m_Off, float m_Global, float m_Local )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float floatswitch2456_g3439( int m_switch, float m_Off, float m_Global, float m_Local )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float3 float3switch2453_g3439( int m_switch, float3 m_Off, float3 m_Global, float3 m_Local )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float3 float3switch3050_g3439( int m_switch, float3 m_Off, float3 m_ActiveFadeOut, float3 m_ActiveFadeIn )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				int _WIND_MODE2462_g3439 = _WindMode;
				int m_switch2458_g3439 = _WIND_MODE2462_g3439;
				...
				float localfloatswitch2458_g3439 = floatswitch2458_g3439( m_switch2458_g3439 , m_Off2458_g3439 , m_Global2458_g3439 , m_Local2458_g3439 );
				float _WIND_STRENGHT2400_g3439 = localfloatswitch2458_g3439;
				int m_switch2468_g3439 = _WIND_MODE2462_g3439;
				...
				float localfloatswitch2468_g3439 = floatswitch2468_g3439( m_switch2468_g3439 , m_Off2468_g3439 , m_Global2468_g3439 , m_Local2468_g3439 );
				...
				float lerpResult2238_g3439 = lerp( 0.8 , ( ( localfloatswitch2468_g3439 / 2.0 ) + 0.9 ) , frac( ( sin( dotResult2341_g3439 ) * 43758.55 ) ));
				...
				int m_switch2312_g3439 = _WIND_MODE2462_g3439;
				float m_Off2312_g3439 = 1.0;
				float m_Global2312_g3439 = _Global_Wind_Main_Pulse;
				float m_Local2312_g3439 = _LocalWindPulse;
				float localfloatswitch2312_g3439 = floatswitch2312_g3439( m_switch2312_g3439 , m_Off2312_g3439 , m_Global2312_g3439 , m_Local2312_g3439 );
				float _WIND_PULSE2421_g3439 = localfloatswitch2312_g3439;
				...
				int m_switch2456_g3439 = _WIND_MODE2462_g3439;
				float m_Off2456_g3439 = 1.0;
				float m_Global2456_g3439 = _Global_Wind_Main_Direction;
				float m_Local2456_g3439 = _LocalWindDirection;
				float localfloatswitch2456_g3439 = floatswitch2456_g3439( m_switch2456_g3439 , m_Off2456_g3439 , m_Global2456_g3439 , m_Local2456_g3439 );
				float _WindDirection2249_g3439 = localfloatswitch2456_g3439;
				...
				float3 localfloat3switch2453_g3439 = float3switch2453_g3439( m_switch2453_g3439 , m_Off2453_g3439 , m_Global2453_g3439 , m_Local2453_g3439 );
				float3 m_Off3050_g3439 = localfloat3switch2453_g3439;
				...
				float3 m_ActiveFadeOut3050_g3439 = ( localfloat3switch2453_g3439 * ( 1.0 - temp_output_3048_0_g3439 ) );
				float3 m_ActiveFadeIn3050_g3439 = ( localfloat3switch2453_g3439 * temp_output_3048_0_g3439 );
				float3 localfloat3switch3050_g3439 = float3switch3050_g3439( m_switch3050_g3439 , m_Off3050_g3439 , m_ActiveFadeOut3050_g3439 , m_ActiveFadeIn3050_g3439 );
				float3 temp_output_309_0_g38532 = localfloat3switch3050_g3439;
						 ...
						 ) : SV_Target
			{
				...
				float4 temp_output_39_0_g39591 = ( float4( temp_output_7_0_g38532 , 0.0 ) + float4(0,0,0,0) );
				...
				float3 ADDITIONAL_LIGHT1342_g38532 = localAdditionalLightsFlat60_g39547;
				float3 temp_output_38_0_g39591 = ( temp_output_1478_59_g38532 + ADDITIONAL_LIGHT1342_g38532 );
...
/*ASEBEGIN
Version=18913
4;29.33333;1436;766;-35.2438;1107.633;1.3;True;False
Node;AmplifyShaderEditor.FunctionNode;385;492.3746,-684.0932;Inherit;False;DESF Module Wind;93;;3439;b135a554f7e4d0b41bba02c61b34ae74;11,938,0,2881,0,2454,0,2457,0,2432,0,2434,0,2433,0,2371,0,2752,0,2995,0,2878,0;0;2;FLOAT3;2190;FLOAT4;2970
Node;AmplifyShaderEditor.CommentaryNode;388;1384.708,-394.293;Inherit;False;317.3666;114.5;DESF Common ASE Compile Shaders;1;389;;0,0.2047877,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;295;1391.783,-1051.665;Inherit;False;171;120.5;;1;379;GLOBAL SETTINGS ;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;390;718.7937,-683.1829;Inherit;False;DESF Core Surface;3;;38532;c3df20d62907cd04086a1eacc41e29d1;19,1352,2,183,2,1382,0,1432,1,1433,1,1434,1,1491,0,1284,0,1446,0,307,0,312,0,1318,0,249,0,1319,0,1336,0,1337,0,1407,0,1443,0,1444,0;2;309;FLOAT3;0,0,0;False;1262;FLOAT4;0,0,0,0;False;10;FLOAT4;42;FLOAT3;39;FLOAT3;1473;COLOR;0;FLOAT4;41;COLOR;43;FLOAT;180;FLOAT;55;FLOAT;281;FLOAT3;313
Node;AmplifyShaderEditor.IntNode;379;1419.669,-1013.518;Inherit;False;Property;_CullMode;Cull Mode;2;2;[Header];[Enum];Create;False;1;GLOBAL SETTINGS;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;2;False;0;1;INT;0
...
Node;AmplifyShaderEditor.FunctionNode;387;1120.408,-679.7432;Inherit;False;DESF Module Detail;66;;39591;49c077198be2bdb409ab6ad879c0ca28;4,200,1,201,1,347,0,346,0;2;39;FLOAT4;0,0,0,0;False;38;FLOAT3;0,0,1;False;2;FLOAT4;73;FLOAT3;72
Node;AmplifyShaderEditor.IntNode;293;1575.595,-847.656;Inherit;False;Property;_ZWriteMode;ZWrite Mode;0;2;[Header];[Enum];Create;False;1;DEBUG SETTINGS;0;1;Off,0,On,1;True;0;False;1;1;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;389;1394.408,-354.693;Inherit;False;DESF Common ASE Compile Shaders;-1;;39598;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
...
WireConnection;390;309;385;2190
WireConnection;390;1262;385;2970
...
WireConnection;374;8;390;313
ASEEND*/
//CHKSM=CF2540F3FD69294F6B0EEA4A6CCB7A30D76A3809