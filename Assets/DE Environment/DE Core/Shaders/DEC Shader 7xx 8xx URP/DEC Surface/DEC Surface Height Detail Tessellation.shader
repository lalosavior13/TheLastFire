...
Shader "DEC/Surface/Surface Height Detail Tessellation"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 float3switch1310_g38531( int m_switch, float3 m_Off, float3 m_Active, float3 m_ActiveReconstructed )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float3 float3switch1387_g38531( int m_switch, float3 m_Off, float3 m_Active, float3 m_ActiveReconstructed )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 temp_output_309_0_g38531 = float3(0,0,0);
				...
				float2 appendResult150_g38531 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38531 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39586 = v.texcoord.xy * appendResult150_g38531 + appendResult151_g38531;
				float2 appendResult6_g39586 = (float2(texCoord2_g39586.x , texCoord2_g39586.y));
				float2 OUT_UV431_g38531 = appendResult6_g39586;
				float2 UV40_g39580 = OUT_UV431_g38531;
				float4 OUT_DISPLAC1180_g38531 = SAMPLE_TEXTURE2D_LOD( _ParallaxMap, sampler_trilinear_repeat, UV40_g39580, 0.0 );
				float4 temp_output_60_0_g39558 = OUT_DISPLAC1180_g38531;
				...
				#endif
				float3 vertexValue = ( temp_output_309_0_g38531 + localfloat3switch74_g39558 );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult150_g38531 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38531 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39586 = IN.ase_texcoord7.xy * appendResult150_g38531 + appendResult151_g38531;
				float2 appendResult6_g39586 = (float2(texCoord2_g39586.x , texCoord2_g39586.y));
				float2 OUT_UV431_g38531 = appendResult6_g39586;
				float2 UV40_g39580 = OUT_UV431_g38531;
				float4 tex2DNode63_g39580 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g39580 );
				float4 OUT_ALBEDO_RGBA1177_g38531 = tex2DNode63_g39580;
				float3 temp_output_7_0_g38531 = ( (_Color).rgb * (OUT_ALBEDO_RGBA1177_g38531).rgb * _Brightness );
				float4 temp_output_39_0_g39591 = ( float4( temp_output_7_0_g38531 , 0.0 ) + float4(0,0,0,0) );
				...
				int _Displacement_Mode1309_g38531 = _Displacement_Mode;
				int m_switch1310_g38531 = _Displacement_Mode1309_g38531;
				float4 OUT_NORMAL1178_g38531 = SAMPLE_TEXTURE2D( _BumpMap, sampler_trilinear_repeat, UV40_g39580 );
				float4 temp_output_1_0_g39549 = OUT_NORMAL1178_g38531;
				...
				float3 temp_output_1478_59_g38531 = unpack52_g39549;
				float3 m_Off1310_g38531 = temp_output_1478_59_g38531;
				float3 m_Active1310_g38531 = temp_output_1478_59_g38531;
				float temp_output_1334_0_g38531 = ( _NormalStrength * 2.0 );
				float temp_output_29_0_g39545 = temp_output_1334_0_g38531;
				float Strength31_g39545 = temp_output_29_0_g39545;
				float localCalculateUVsSmooth19_g39545 = ( 0.0 );
				float2 temp_output_96_0_g39545 = OUT_UV431_g38531;
				...
				float3 m_ActiveReconstructed1310_g38531 = localCombineSamplesSmooth31_g39545;
				float3 localfloat3switch1310_g38531 = float3switch1310_g38531( m_switch1310_g38531 , m_Off1310_g38531 , m_Active1310_g38531 , m_ActiveReconstructed1310_g38531 );
				float3 NORMAL_OUT314_g38531 = localfloat3switch1310_g38531;
				float3 temp_output_16_0_g39547 = NORMAL_OUT314_g38531;
				...
				float3 ADDITIONAL_LIGHT1342_g38531 = localAdditionalLightsFlat60_g39547;
				float3 temp_output_38_0_g39591 = ( localfloat3switch1310_g38531 + ADDITIONAL_LIGHT1342_g38531 );
				...
				float4 _MASK_B1440_g38531 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_trilinear_repeat, UV40_g39580 );
				...
				int m_switch1387_g38531 = _Displacement_Mode1309_g38531;
				...
				float3 temp_output_1478_66_g38531 = worldNormal67_g39549;
				float3 m_Off1387_g38531 = temp_output_1478_66_g38531;
				float3 m_Active1387_g38531 = temp_output_1478_66_g38531;
				...
				float3 m_ActiveReconstructed1387_g38531 = tangentToWorldDir104_g39545;
				float3 localfloat3switch1387_g38531 = float3switch1387_g38531( m_switch1387_g38531 , m_Off1387_g38531 , m_Active1387_g38531 , m_ActiveReconstructed1387_g38531 );
				float3 NORMAL_WORLD_OUT164_g38531 = localfloat3switch1387_g38531;
				float3 temp_output_4_0_g39551 = NORMAL_WORLD_OUT164_g38531;
				...
				float4 break377_g38531 = OUT_ALBEDO_RGBA1177_g38531;
				float ALBEDO_R169_g38531 = break377_g38531.r;
				float4 temp_cast_11 = (ALBEDO_R169_g38531).xxxx;
				...
				float4 _MASK_G1438_g38531 = SAMPLE_TEXTURE2D( _SmoothnessMap, sampler_trilinear_repeat, UV40_g39580 );
				float4 temp_output_83_0_g39551 = _MASK_G1438_g38531;
				...
				float4 temp_output_1267_33_g38531 = localfloat4switch99_g39551;
				float4 color301_g38531 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 _MASK_R1439_g38531 = SAMPLE_TEXTURE2D( _OcclusionMap, sampler_trilinear_repeat, UV40_g39580 );
				float4 temp_cast_13 = (IN.ase_color.a).xxxx;
				float4 lerpResult11_g38531 = lerp( _MASK_R1439_g38531 , temp_cast_13 , (float)_OcclusionSourceMode);
				float4 lerpResult14_g38531 = lerp( color301_g38531 , lerpResult11_g38531 , _OcclusionStrengthAO);
				
				float3 Albedo = localfloat4switch125_g39591.xyz;
				float3 Normal = localfloat3switch127_g39591;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( _MetallicStrength * _MASK_B1440_g38531 ).r;
				float Smoothness = ( temp_output_1267_33_g38531 * lerpResult14_g38531 ).x;
				float Occlusion = saturate( lerpResult14_g38531 ).r;
				float Alpha = 1;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float2 appendResult150_g38531 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38531 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39586 = v.ase_texcoord.xy * appendResult150_g38531 + appendResult151_g38531;
				float2 appendResult6_g39586 = (float2(texCoord2_g39586.x , texCoord2_g39586.y));
				float2 OUT_UV431_g38531 = appendResult6_g39586;
				float2 UV40_g39580 = OUT_UV431_g38531;
				float4 OUT_DISPLAC1180_g38531 = SAMPLE_TEXTURE2D_LOD( _ParallaxMap, sampler_trilinear_repeat, UV40_g39580, 0.0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult150_g38531 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38531 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g39586 = IN.ase_texcoord2.xy * appendResult150_g38531 + appendResult151_g38531;
				float2 appendResult6_g39586 = (float2(texCoord2_g39586.x , texCoord2_g39586.y));
				float2 OUT_UV431_g38531 = appendResult6_g39586;
				float2 UV40_g39580 = OUT_UV431_g38531;
				float4 tex2DNode63_g39580 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g39580 );
...
/*ASEBEGIN
Version=18913
4;29.33333;1436;766;-18.86884;1307.275;1.467227;True;False
Node;AmplifyShaderEditor.CommentaryNode;384;1051.405,-1064.661;Inherit;False;321.3963;366.2526;Tessellation;4;385;388;387;386;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;290;1386.96,-890.2607;Inherit;False;346.5028;193.4201;DEBUG SETTINGS ;3;291;353;293;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;295;1391.883,-1025.165;Inherit;False;169.8016;121.5983;GLOBAL SETTINGS ;1;379;;0.009433985,0.009433985,0.009433985,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;392;1382.043,-386.2931;Inherit;False;314.502;117.4504;DESF Common ASE Compile Shaders;1;393;;0,0.2047877,1,1;0;0
Node;AmplifyShaderEditor.FunctionNode;394;715.068,-684.437;Inherit;False;DESF Core Surface;3;;38531;c3df20d62907cd04086a1eacc41e29d1;19,1352,2,183,2,1382,0,1432,1,1433,1,1434,1,1491,0,1284,0,1446,0,307,0,312,0,1318,1,249,1,1319,1,1336,0,1337,0,1407,0,1443,0,1444,0;2;309;FLOAT3;0,0,0;False;1262;FLOAT4;0,0,0,0;False;10;FLOAT4;42;FLOAT3;39;FLOAT3;1473;COLOR;0;FLOAT4;41;COLOR;43;FLOAT;180;FLOAT;55;FLOAT;281;FLOAT3;313
Node;AmplifyShaderEditor.FunctionNode;393;1389.493,-348.0308;Inherit;False;DESF Common ASE Compile Shaders;-1;;39598;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;391;1124.508,-680.7392;Inherit;False;DESF Module Detail;70;;39591;49c077198be2bdb409ab6ad879c0ca28;4,200,1,201,1,347,0,346,0;2;39;FLOAT4;0,0,0,0;False;38;FLOAT3;0,0,1;False;2;FLOAT4;73;FLOAT3;72
Node;AmplifyShaderEditor.IntNode;293;1580.395,-853.0177;Inherit;False;Property;_ZWriteMode;ZWrite Mode;0;2;[Header];[Enum];Create;False;1;DEBUG SETTINGS;0;1;Off,0,On,1;True;0;False;1;1;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;388;1079.891,-791.2325;Half;False;Property;_TessellationPhong;Tessellation Phong;67;0;Create;False;1;;0;0;True;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;379;1419.769,-987.0179;Inherit;False;Property;_CullMode;Cull Mode;2;2;[Header];[Enum];Create;False;1;GLOBAL SETTINGS;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;387;1073.904,-950.7377;Half;False;Property;_TessellationDistanceMin;Tessellation Distance Min;68;0;Create;False;1;;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;385;1077.72,-871.5591;Half;False;Property;_TessellationDistanceMax;Tessellation Distance Max ;69;0;Create;False;1;;0;0;True;0;False;5;2000;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;386;1073.405,-1024.953;Half;False;Property;_TessellationStrength;Tessellation Strength;66;0;Create;False;1;;0;0;True;1;Header(TESSELLATION URP);False;6;0.5;0.001;100;0;1;FLOAT;0
...
WireConnection;391;39;394;42
WireConnection;391;38;394;39
WireConnection;374;0;391;73
WireConnection;374;1;391;72
WireConnection;374;3;394;0
WireConnection;374;4;394;41
WireConnection;374;5;394;43
WireConnection;374;8;394;313
ASEEND*/
//CHKSM=E808133D958F2BF33B058A7BC8320A7A2B84A761